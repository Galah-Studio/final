...
// components/viviProjectHeader.tsx
...
// Define the viviProjectHeader component (rename the component)
const viviProjectHeader = () => {
...
// Export the viviProjectHeader component
export default viviProjectHeader;
