...
const BirdLogoSVG = () => {
  return (
    ...
    >
      ...
      <path 
        className="b" 
        d="M444.47,287.74c-3.95.99-10.35-6.83-13.04-12.3-11.15-22.59-17.41-47.56-17.41-72.93,0-67.6,42.35-126.63,104.92-151.08,7.98-3.12,6.76,1.02,6.48,3.1s-.48,5.33-3.01,6.28c-59.05,21.96-98.39,78.3-98.39,141.7,0,23.79,5.04,47.64,16.32,68.39,5.97,10.99,9.28,15.56,4.13,16.83h0Z"
      />
      <path 
        className="b" 
        d="M514.38,351.81c-15.74-6.53-30.33-15.26-43.38-26.33-2.15-1.83-9.58-8.15-4.1-9.42s8.52.05,10.58,1.8c12.23,10.38,25.93,18.54,40.67,24.69q10.85,4.52,10.85,9.23c0,4.7-3.34,4.71-14.61.03Z"
      />
      <path 
        className="b" 
        d="M602.78,356.11c.42-4.38,1.88-4.61,12.54-7.82,37.02-11.14,69.47-34.7,89.48-67.97,1.39-2.31,2.07-3.73,7.16-4.78,5.46-1.13,6.21,2.07,1.42,9.93-21.33,35.46-55.64,61.58-95.41,72.46-6.62,1.81-15.9,5.56-15.19-1.82Z"
      />
      <path 
        className="b" 
        d="M731.19,249.13c4.84-15.13,7-30.76,7-46.61,0-67.6-43.63-128.51-104.92-152.08-17.75-6.83-18.51-6.85-20.77-5.16-1.75,1.32,1.82,7.63,5.23,8.74,10.7,3.48,10.38,4.29,12.91,5.24,59.05,21.96,97.55,79.86,97.55,143.25,0,14.62-1.9,29.26-5.99,43.2-.51,1.75-3.7,8.51-.59,9.92,5.31,2.41,8.5-3.13,9.58-6.51Z"
      />
      <line 
        className="b" 
        x1="722.2" 
